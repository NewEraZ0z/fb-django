...
def fetch_pages(request):
    user_access_token = 'EAAGnLttZBmZCMBOZBKCdWa01Jvmrq4Dpib7bPdC2CrzFLHy7zOhxHS3Q0iENQtRSNpGSr0gBZCCITb81a3fj1uDCdRSMIZAAWNIZBQvPopoR6ZCxUrcDjz8VWjtZADWyh4Dj6tAGGZB5xbU1tRLc2pWZC5ytIC1aHbp6XUcsFg1gZCucHJdVsRKkYS4aKyDZCLTTLVJZAHmQWpXa8qCGgtF7Nwmvl3B3g9LYZD'  # Replace with your actual user access token
...
# # load liste pages 
# def fetch_pages(request):
#     user_access_token = 'EAAGnLttZBmZCMBOZCIXf7Aus1c905m8ZCk1fUB68gv3CGYrl4Nb9O6w2vwlXtFrA3o4Sn7LdjM8h06CJBLm69bdVx78OcttKEfnIdtkuMYTzXo3qi9cCHGcQeEHSWmsR50WZBkXVRmQfUAnpZBpvsd9hZCdUbGxoZAYxYsUle9rE2WY1o1bMcC90wkSWZAkoeVvEu9xFLXsS1EYKb5kZAOhefzhcPqVAZDZD'  # Replace with your actual user access token
#     user_id = '122103504482407107'  # Replace with your actual user ID
#     url = f"https://graph.facebook.com/{user_id}/accounts"
#     params = {
#         'access_token': user_access_token,
